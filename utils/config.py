...
def get_args_StopSign():
    ...
    parser.add_argument('-labeldir','--label-dir',help='yolo label dir',default="/home/ali/Projects/datasets/bdd100k_data/labels/detection/train")
    ...
    ## stop sign label
    parser.add_argument('-roilabel','--roi-label',type=int,default=9,help='stop sign label = 9')
...
def get_args_LaneMarking():
    ...
    ## lane marking label
    parser.add_argument('-roilabel','--roi-label',type=int,default=10,help='lanemark label = 11')
...
def get_args_Pedestrain():
    ...
    ## Others setting
    parser.add_argument('-numimg','--num-img',type=int,default=19999,help='number of generate fake pedestrain images')
