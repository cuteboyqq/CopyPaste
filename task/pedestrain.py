...
class PedestrainDataset(BaseDatasets):
    ...
    def Get_ROI_XY_In_Image(self,vanish_y,carhood_ratio):
        ...
        y = random.randint(vanish_y-50,int(self.im.shape[0]*carhood_ratio))
    ...
    def Get_ROI_WH_In_Image(self,roi,roi_mask,dri_path):
        ...
        while(OVERLAPPED and cnt<=200):
            ...
            if self.roi_w > 150:
                ...
                self.roi_w = 150
                self.roi_h = int(self.roi_h * float(150/roi_w_pre))
                print("case 1 : self.roi_w > 150")
                print("after correct")
            ...
            if self.roi_h > 150:
                ...
                self.roi_h = 150
                self.roi_w = int(self.roi_w * float(150/roi_h_pre))
                print("case 2 : self.roi_h > 150")
                print("after correct")
                print("self.roi_w:{}".format(self.roi_w))
                print("self.roi_h:{}".format(self.roi_h))
